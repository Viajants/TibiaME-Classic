...
import com.pupilla.dpk.Backend.items.ItemController;
import com.pupilla.dpk.Backend.items.NewItemClass;
...
public  class Item implements Serializable {
    ...
    public enum Type{
        weapon, shield, legs, armor, helmet, ring, amulet
    }
    ...
    private void setTexturePath(String name){
        if(name!=null){
            ...
            if(name.equals(Constants.eqCometSword)){
                texturePath = Constants.cometSword;
                return;
            }
            if(name.equals(Constants.eqTempestRod)){
                texturePath = Constants.tempestRod;
                return;
            }

            if(name.equals(Constants.eqFrostHelmet)){
                texturePath = Constants.frostHelmet;
                return;
            }

            if(name.equals(Constants.eqCrystalRing)){
                texturePath = Constants.crystalRing;
                return;
            }


            if(name.equals(Constants.eqFrostArmor)){
                texturePath = Constants.frostArmor;
                return;
            }


            if(name.equals(Constants.eqGown)){
                texturePath = Constants.gown;
                return;
            }

            if(name.equals(Constants.eqDragonSlayer)){
                texturePath = Constants.dragonSlayer;
                return;
            }



            if(name.equals(Constants.eqIceDiscus)){
                texturePath = Constants.iceDiscus;
                return;
            }


            if(name.equals(Constants.eqCrystalChain)){
                texturePath = Constants.crystalChain;
                return;
            }
            ...
            if(name.equals(Constants.eqAmuletOfSnow)){
                texturePath = Constants.amuletOfSnow;
                return;
            }


            if(name.equals(Constants.eqFrostLegs)){
                texturePath = Constants.frostLegs;
                return;
            }


            if(name.equals(Constants.eqIceShield)){
                texturePath = Constants.iceShield;
                return;
            }


            if(name.equals(Constants.eqSpiritBlade)){
                texturePath = Constants.spiritBlade;
                return;
            }
            ...
            if(name.equals(Constants.eqFireSword)){
                texturePath = Constants.fireSword;
                return;
            }

            if(name.equals(Constants.eqTalisman)){
                texturePath = Constants.talisman;
                return;
            }
            if(name.equals(Constants.eqBrassLegs)){
                texturePath = Constants.brassLegs;
                return;
            }

            if(name.equals(Constants.eqVulcanicAxe)){
                texturePath = Constants.volcanicAxe;
                return;
            }

            if(name.equals(Constants.eqEmberRune)){
                texturePath = Constants.emberRune;
                return;
            }
            ...
            if(name.equals(Constants.eqBattleHelmet)){
                texturePath = Constants.battleHelmet;
                return;
            }

            if(name.equals(Constants.eqRoundShield)){
                texturePath = Constants.roundShield;
                return;
            }
